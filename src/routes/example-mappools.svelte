...
<TourneyNav frontUrl={frontUrl} mappoolsUrl={mappoolsUrl} playersUrl={playersUrl} highlight="Mappools"/>
<div class="container card" id="mappools">
    <CardTitle title="Mappools"/>
    {#each mappools as mappool}
        <MappoolBanner imageUrl={mappool.imageUrl} stageName={mappool.stageName} mappoolUrl={mappool.mappoolUrl}/>
    {/each}
</div>
